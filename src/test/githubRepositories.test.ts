...
suite('GitHub Repositories', () => {
    ...
    test('groups repositories by visibility and then language', async () => {
        ...
        assert.strictEqual(repositoryNodes[0].description, '· private-python description');
        assert.strictEqual(repositoryNodes[0].collapsibleState, vscode.TreeItemCollapsibleState.None);
        ...
        assert.deepStrictEqual(await tree.getChildren(repositoryNodes[0]), []);
        ...
        assert.strictEqual(collapsedRepositoryNode.collapsibleState, vscode.TreeItemCollapsibleState.None);
        ...
        assert.strictEqual(expandedRepositoryNode.collapsibleState, vscode.TreeItemCollapsibleState.None);
    });

    test('omits the title separator when a GitHub repository has no description', async () => {
        ...
        assert.strictEqual(repositoryNode.description, '');
